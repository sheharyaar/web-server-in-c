...
set pyxversion=3
set ruler
set runtimepath=~/.vim,~/.vim/plugged/vim-github-dark,~/.vim/plugged/ayu-vim,~/.vim/plugged/vim-airline,~/.vim/plugged/nerdtree,~/.vim/plugged/limelight.vim,~/.vim/plugged/preview-markdown.vim,~/.vim/plugged/vimsence,/usr/share/vim/vimfiles,/usr/share/vim/vim82,/usr/share/vim/vimfiles/after,~/.vim/after
set scrolloff=5
...
silent only
silent tabonly
cd ~/Desktop/Programs/courses/network/p1/src
...
silent! normal! zE
let &fdl = &fdl
let s:l = 30 - ((8 * winheight(0) + 15) / 30)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 30
...
silent! normal! zE
let &fdl = &fdl
let s:l = 106 - ((24 * winheight(0) + 15) / 30)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 106
